...
description: "When creating time-faceted maps in ggplot2, you might notice that things start to slow down as more time periods are added..."
author: "H. Sherry Zhang"
date: '2022-05-21'
slug: []
categories: [data visualization, spatial data]
tags: []
subtitle: ''
summary: ''
authors: []
...
This example comes from [Chapter 7](https://www.paulamoraga.com/book-geospatial/sec-arealdataexamplest.html) of Paula Moraga's book *Geospatial Health Data: Modeling and Visualization with R-INLA and Shiny* and I have simplified it for my demonstration. In essence, there are two datasets:
...
The details on calculating SIR is not the focus of this post and Section [7.1](https://www.paulamoraga.com/book-geospatial/sec-arealdataexamplest.html#sec-arealdataexamplest) to [7.2](https://www.paulamoraga.com/book-geospatial/sec-arealdataexamplest.html#data-preparation-1) of Paula's book has detailed all the steps you need if interested. Here I attach the script to generate these two data in case you would like to give it a spin:
