...
tribble(
  ...
  "CANSSI Ontario Stats. Software Conf.", "Nov 2022", "virtual", "(upcoming) Switching between space and time: Spatio-temporal analysis with cubble", "https://canssiontario.utoronto.ca/event/statistical-software-conference/",
  
  "ECSS Mini Conf. 2022", "Nov 2022", "virtual", "(upcoming) Switching between space and time: Spatio-temporal analysis with cubble", "https://ecssmini2022.netlify.app/",
  ...
  "Young Stats. Conf. 2019", "Oct 2019", "Canberra, Australia", "Exploration of judicial facial expression in videos of legal proceedings", "               ") %>%
  brief_entries(what = glue::glue("<topic>\\newline \\url{<link>}", .open = "<", .close = ">"), when = paste0(date, "\\newline"), with = paste0(conf, "\\newline"), .protect = FALSE)
```
...
tribble(
  ...
  "Uni. of Washington",  "Jul 20", "Summer Institute in Statistics for Big Data (SISBID)",
  "on building static graphics with ggplot2 and interactive graphics include but not limited to plotly, gganimate, and tourr", "https://github.com/dicook/SISBID",
...
tribble(
  ~ conf, ~ date, ~ where, ~ topic, ~ link,
  "WOMBAT 2022", "Dec 2022", "aaa", "(upcoming) Wrangling spatio-temporal data with R", "https://numbats.github.io/WOMBAT2022/tutorial/sherry.html",
  
  "R Ladies Melbourne", "Sept 2022", "onsite", "Switching between space and time: Spatio-temporal analysis with cubble", "https://sherryzhang-rladiesmelb2022.netlify.app/") %>%
  brief_entries(what = glue::glue("<topic>\\newline \\url{<link>}", .open = "<", .close = ">"), when = paste0(date, "\\newline"), with = paste0(conf, "\\newline"), .protect = FALSE)
```
...
tribble(
  ~ grants, ~ dates, ~ where,
  "CSIRO Data61 Postgraduate Research Scholarship ", "20 - 23", "CSIRO",
  "Monash Business School Co-Funded Graduate Research Scholarship ", " 20 - 23", "Monash University",
  "Dean's Honours List", "2020", "Monash University",
  "Monash Summer Vacation Research Scholarship", "2019", "Monash University") %>% 
